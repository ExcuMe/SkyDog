  ...
  <body >
        ...
        <div class="col-sm-offset-2 col-md-offest-2">
            ...
            <div  class="form-horizontal">
                <div class="form-group">
                    <label for="commonuser" class="col-sm-2 col-md-2 control-label">用户类别</label>
                    <div class="col-sm-6 col-md-6">
                        <label class="radio-inline">
                            <input type="radio" id="commonuser" value="option1" name="user"> 会员
                        </label>
                        <label class="radio-inline">
                            <input type="radio" id="shopuser" value="option2"  name="user"> 商家
                        </label>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <label class="radio-inline">
                            <input type="radio" id="man" value="option1" name="sex"> 男
                        </label>
                        <label class="radio-inline">
                            <input type="radio" id="woman" value="option2" name="sex"> 女
                        </label>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-6">
                        <button class="btn btn-lg btn-primary btn-block" style="background-color: #FF9800;" type="submit" onclick="startRegister()">注册</button>
                    </div>
                </div>
            </div>
            <br/>
    ...
    <script type="text/javascript">
        function startRegister() {
            ...
            user.role=0;
            if(document.getElementById("shopuser").checked)
                user.role=2;
            ...
            if(user.nickName === ''){
                ...
                layer.msg('昵称长度不能超过15个字符',{icon:2});//icon为弹出窗口的样式;
                return;
            }
            ...
            if(registerResult === 'success'){
                ...
                layer.close(loading);
                layer.msg('这个用户名已存在！',{icon:2});
            }
            else if(registerResult === 'emailExist'){
                layer.close(loading);
                layer.msg('这个邮箱已经被注册啦！',{icon:2});
            }
