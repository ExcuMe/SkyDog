		...
		<div class="row margin-t">
			<div class="form-horizontal">
				...
				<div class="form-group form-group-lg col-sm-6 col-md-6">
					<input type="text" class="form-control" id="newSearchKeyWord" placeholder="SkyDog入门与精通" />
				</div>
				<button class="btn btn-primary btn-lg col-sm-2 col-md-2 big-button" style="background-color: #FF9800;" onclick="searchPre()">查找商品</button>
			</div>
		</div>
	</div>
	<div class="container">
