...
<body >
<!--导航栏部分  nav定义导航链接的部分-->
<nav class="navbar navbar-default navbar-fixed-top" style="background-color:#303F9F">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
            ...
            <ul class="nav navbar-nav navbar-right"  >
                <c:if test="${empty currentUser}">
                    <li ><a href="${cp}/register" methods="post" style="color: white ;">注册</a></li>
                    <li><a href="${cp}/login" methods="post" style="color: white ;">登录</a></li>
                </c:if>
                <c:if test="${not empty currentUser}">
                    <c:if test="${currentUser.role == 1}">
                        <li><a href="${cp}/control" methods="post">管理员控制台</a></li>
                    </c:if>
                    <c:if test="${currentUser.role == 2}">
                        <li ><a href="${cp}/shopcontrol" methods="post">商家控制台</a></li>
                    </c:if>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" >
                            ...
                            <li ><a href="${cp}/change_info">个人资料修改</a></li>
            ...
            <div class="navbar-form navbar-right">
                ...
                <button class="btn btn-default" onclick="searchProduct();" style="background-color:  #C5CAE9">查找商品</button>
            </div>
        </div>
    </div>
</nav>
